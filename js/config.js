 ...
 * Sin asesor, sin videos y sin labels de imágenes.
 */
...
window.NUTRIVELT_CONFIG = {
  ...
  media: {
    ...
    empathyMap: {
      ...
      alt: 'Mapa de empatía del proyecto'
    },

    cover: {
      src: 'assets/images/productofoto.jpeg',
      alt: 'Foto representativa del proyecto'
    }
  },
  ...
  competition: [

    {
      ...
      features: 'Productos procesados de consumo frecuente, disponibles en tiendas y quioscos.',
      strengths: 'Fácil disponibilidad, variedad de sabores y precios accesibles.',
      limits: 'No necesariamente priorizan ingredientes de origen vegetal o una propuesta orientada a mejorar la calidad de la alimentación.'
    },

    {
      product: 'Productos de panadería tradicional',
      features: 'Preparaciones dulces o saladas elaboradas principalmente con harinas convencionales.',
      strengths: 'Son conocidos por los consumidores y tienen amplia aceptación.',
      limits: 'La propuesta nutricional y la combinación de ingredientes puede ser menos diferenciada.'
    },

    {
      product: 'NUTRIVELT',
      features: 'Snack elaborado con camote, zapallo, harina de garbanzo, especias y otros ingredientes seleccionados.',
      strengths: 'Propuesta práctica, accesible, diferenciada por sus ingredientes y con presentación pensada para el consumo cotidiano.',
      limits: 'Es un producto nuevo que necesita seguir fortaleciendo su reconocimiento y aceptación en el mercado.'
    }
  ],
  ...
  designThinking: [

    {
      ...
      number: '01',
      title: 'Empatizar',
      summary: 'Se exploraron las necesidades y hábitos de consumo relacionados con los snacks.',
      result: 'Se identificó la necesidad de contar con una alternativa práctica y agradable frente al consumo frecuente de snacks convencionales.',
      media: {
...

    {
      ...
      number: '02',
      title: 'Definir',
      summary: 'Se organizó la información obtenida para establecer el problema principal.',
      result: 'El reto se centró en desarrollar un snack accesible que incorpore ingredientes seleccionados y que resulte atractivo para el consumidor.',
      media: {
        src: 'assets/images/Imagen del problema.jpg'
      }
    },

    {
      ...
      number: '03',
      title: 'Idear',
      summary: 'Se plantearon diferentes alternativas de productos y presentaciones.',
      result: 'La generación de ideas permitió explorar diferentes opciones hasta orientar el proyecto hacia una propuesta de snack diferenciada.',
      media: {
...

    {
      ...
      number: '04',
      title: 'Prototipar',
      summary: 'Se elaboraron diferentes versiones para comprobar y mejorar la propuesta.',
      result: 'Los prototipos permitieron realizar cambios progresivos en la preparación, presentación y propuesta del producto.',
      media: {
        src: 'assets/images/Tercer prototipo - evolución_.jpg'
      }
    },

    {
      ...
      number: '05',
      title: 'Evaluar',
      summary: 'Se observaron los resultados de las pruebas y se identificaron aspectos de mejora.',
      result: 'La evaluación permitió orientar la versión final hacia una presentación más adecuada para su consumo y comercialización.',
      media: {
  ...
  prototypeJourney: [

    {
      ...
      subtitle: 'Picarones',
      date: '2026',
      description: 'Primera aproximación al desarrollo de una propuesta de snack a partir de una preparación conocida.',
      result: 'Permitió identificar aspectos que podían mejorarse en sabor, presentación y diferenciación.',
      learning: 'La primera propuesta permitió conocer mejor las preferencias del público y detectar la necesidad de realizar cambios.',
      media: {
        src: 'assets/images/Primer prototipo_.jpg'
      }
    },

    {
      ...
      date: '2026',
      description: 'Se revisó la propuesta inicial y se decidió orientar el proyecto hacia una alternativa de snack con ingredientes seleccionados.',
      result: 'El proyecto tomó una dirección más definida y diferenciada.',
      learning: 'La retroalimentación y la observación permitieron ajustar la idea inicial.',
      media: {
        src: 'assets/images/Segundo prototipo.jpg'
      }
    },

    {
      ...
      subtitle: 'Churros',
      date: '2026',
      description: 'Se desarrolló una nueva alternativa para evaluar aceptación, preparación y presentación.',
      result: 'La nueva versión permitió seguir comparando características y preferencias.',
      learning: 'Probar diferentes alternativas ayuda a identificar qué elementos deben mantenerse y cuáles necesitan cambios.',
      media: {
        src: 'assets/images/Segundo prototipo.jpg'
      }
    },

    {
      ...
      subtitle: 'Ocho Locos',
      date: '2026',
      description: 'Se continuó experimentando con la propuesta hasta encontrar una orientación más adecuada para el producto.',
      result: 'La experimentación permitió acercarse progresivamente a la versión final.',
      learning: 'El prototipado permite aprender mediante la práctica y realizar mejoras sucesivas.',
      media: {
        src: 'assets/images/Tercer prototipo - evolución_.jpg'
      }
    },

    {
      ...
      subtitle: 'NUTRIVELT',
      date: '2026',
      description: 'Se consolidó la propuesta NUTRIVELT como snack nutritivo, accesible y pensado para todos.',
      result: 'Se obtuvo una presentación final lista para continuar con las etapas de validación y comercialización.',
      learning: 'La mejora progresiva permitió transformar las primeras ideas en una propuesta de producto más definida.',
      media: {
        src: 'assets/images/Foto del procuto final_.jpg'
      }
    }
  ...
  survey: {
    ...
    note: 'Se consideraron 10 respuestas para conocer la percepción inicial sobre sabor, presentación, precio e intención de compra.',
    results: [
      {
        label: 'Sabor',
        value: 9,
  ...
  validationPlan: [

    {
      ...
      hypothesis: 'Los consumidores mostrarán interés por una alternativa de snack elaborada con ingredientes seleccionados.',
      actions: 'Presentar la propuesta, explicar sus ingredientes y recoger opiniones sobre sabor, presentación y utilidad.',
      indicators: 'Número de personas interesadas y comentarios favorables sobre la propuesta.',
      time: 'Semana 9'
    },

    {
      phase: 'Prueba de producto',
      hypothesis: 'Una presentación práctica y un sabor agradable favorecerán la aceptación del producto.',
      actions: 'Realizar degustaciones y recoger opiniones sobre sabor, textura, tamaño y presentación.',
      indicators: 'Nivel de aceptación, comentarios de mejora e intención de compra.',
      time: 'Semana 10'
    },

    {
      phase: 'Ajuste y venta',
      hypothesis: 'La versión mejorada podrá comercializarse a un precio accesible para el público objetivo.',
      actions: 'Realizar ajustes finales, establecer precio, presentar el producto y efectuar ventas directas.',
      indicators: 'Cantidad de unidades vendidas, aceptación del precio y comentarios posteriores a la compra.',
  ...
  leanCanvas: [
    ...
    {
      title: '1. Problema',
      text: 'Consumo frecuente de snacks convencionales entre estudiantes y necesidad de contar con alternativas prácticas y accesibles.'
    },

    {
      title: '2. Segmento de clientes',
      text: 'Estudiantes, jóvenes y personas que buscan una opción práctica de snack para consumir durante el día.'
    },

    {
      title: '3. Propuesta única de valor',
      text: 'Snack nutritivo, accesible y pensado para todos, elaborado con ingredientes seleccionados y una presentación práctica.'
    },

    {
      title: '4. Solución',
      text: 'Desarrollo de NUTRIVELT mediante una combinación de ingredientes como camote, zapallo, harina de garbanzo y especias.'
    },

    {
      title: '5. Canales',
      text: 'Venta directa, WhatsApp, redes sociales, cafetines, tiendas cercanas y recomendaciones entre consumidores.'
    },

    {
      title: '6. Métricas clave',
      text: 'Unidades vendidas, número de clientes, intención de recompra, aceptación del producto y satisfacción del consumidor.'
    },

    {
      title: '7. Ventaja injusta',
      text: 'Combinación diferenciada de ingredientes, proceso de experimentación y propuesta orientada a ofrecer una alternativa práctica y accesible.'
    },

    {
      title: '8. Flujo de ingresos',
      text: 'Venta individual a S/ 3.00 y promoción de 2 envases por S/ 5.00.'
    },

    {
      title: '9. Estructura de costos',
      text: 'Ingredientes, envases, etiquetas, materiales de elaboración, transporte, promoción y otros gastos asociados a la producción y comercialización.'
    }
  ],
  ...
  acquisition: [
    ...
    {
      title: 'Publicidad',
      description: 'Difusión de NUTRIVELT mediante piezas gráficas y fotografías del producto.',
    ...
    {
      title: 'Afiches',
      description: 'Material gráfico para comunicar las características, precio y propuesta de valor.',
...

    {
      ...
      description: 'Publicaciones orientadas a mostrar el producto, sus ingredientes y beneficios de la propuesta.',
      link: 'https://www.instagram.com/',
      media: {
        src: 'assets/images/Foto del procuto final_.jpg'
      }
    ...
    {
      title: 'Venta directa',
      description: 'Comercialización directa del producto al público objetivo.',
    ...
    {
      title: 'Promociones',
      description: 'Oferta de dos envases por S/ 5.00 para incentivar la compra de más de una unidad.',
      link: 'https://wa.me/51999999999',
      media: {
        src: 'assets/images/Foto principal del Producto_.jpg'
      }
  ...
  retention: [

    {
      ...
      action: 'Solicitar comentarios sobre sabor, presentación y experiencia de consumo, además de comunicar nuevas promociones.',
      evidence: 'Registro de ventas, comentarios de clientes y seguimiento de intención de recompra.'
    }
  ],
  ...
  evidence: [
    ...
    {
      type: 'Fotografía',
      description: 'Registro fotográfico del proceso de desarrollo y presentación de NUTRIVELT.',
      date: '2026',
      media: {
        src: 'assets/images/Foto principal del Producto_.jpg'
      },
    ...
    {
      type: 'Documento',
      description: 'Material documental relacionado con el desarrollo del proyecto NUTRIVELT.',
      date: '2026',
      media: {
        src: 'assets/images/Logotipo del proyecto.jpg'
      },
    ...
    {
      type: 'Encuesta',
      description: 'Registro de las respuestas utilizadas para conocer la percepción inicial del producto.',
      date: '2026',
      media: {
        src: 'assets/images/Foto de resultado de obsevación.jpg'
      },
    ...
    {
      type: 'Registro',
      description: 'Registro visual del proceso de elaboración y evolución del producto.',
      date: '2026',
      media: {
        src: 'assets/images/Preparación.jpg'
      },
    ...
    {
      type: 'Constancia',
      description: 'Evidencia visual asociada a la participación y desarrollo del proyecto.',
      date: '2026',
      media: {
        src: 'assets/images/Logotipo del proyecto.jpg'
      },
  ...
  team: [

    {
      ...
      description: 'Responsable de participar en el desarrollo, prototipado, validación y presentación del proyecto NUTRIVELT.',
      media: {
        src: 'assets/images/Logotipo del proyecto.jpg'
      }
    }
